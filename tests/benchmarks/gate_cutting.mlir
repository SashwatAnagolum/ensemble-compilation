module {    
    func.func private @gate_cutting_iteration(%circuit_index: index, %qubits: tensor<4x!ensemble.physical_qubit>, %bits: tensor<6x!ensemble.cbit>, %params: tensor<5x2x4xf64>, %should_perform_qpd_meas_on_control: tensor<6xi1>, %should_perform_qpd_meas_on_target: tensor<6xi1>) {
        ...
        ensemble.quantum_program_iteration {
            ...
            scf.for %layer_index = %zero_index to %four_index step %one_index {
                ...
                scf.for %control = %zero_index to %three_index step %one_index {
