module {
    ...
    func.func private @iteration_body(%qubits: tensor<8 x !ensemble.physical_qubit>, %cbits: tensor<8 x !ensemble.cbit>, %circuit_index : i32) {
        ...
        ensemble.quantum_program_iteration {
            ...
            scf.for %i = %zero_index to %seven_index step %one_index {
            ...
            ensemble.transmit_results %cbits : (tensor<8 x !ensemble.cbit>) -> ()
        }
        return
    }
    func.func @main() {
