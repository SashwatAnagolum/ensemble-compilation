...
module {
  func.func private @iteration_body(%circuit_index: index, %beta_values: tensor<8xf64>, %gamma_values: tensor<8xf64>, %qubits: tensor<8x!ensemble.physical_qubit>, %bits: tensor<8x!ensemble.cbit>) {
