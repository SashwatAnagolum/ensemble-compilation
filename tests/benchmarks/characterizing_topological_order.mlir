module {
    func.func @iteration_body(%qubits: tensor<31x!ensemble.physical_qubit>, %bits: tensor<31x!ensemble.cbit>, %circuit_index: index, %qubits_to_measure: tensor<9xi32>) -> () {
        ...
        affine.for %i = 0 to 3 step 1 {
            ...
            %nine_i_plus_seven = arith.addi %nine_i_mul, %eleven_i32 : i32
