        ...
        ensemble.quantum_program_iteration {
          ...
          scf.for %arg2 = %c0 to %22 step %c1 {
            ...
            scf.for %arg3 = %c0 to %23 step %c1 {
              ...
              ensemble.apply_distribution %14[%extracted_3] {"cannot-merge"} %extracted_4 : (!ensemble.gate_distribution, i32, !ensemble.physical_qubit) -> ()
              ensemble.apply_distribution %15[%extracted_3] {"cannot-merge"} %extracted_5 : (!ensemble.gate_distribution, i32, !ensemble.physical_qubit) -> ()
              ensemble.apply %13 %extracted_4, %extracted_5 : (!ensemble.gate, !ensemble.physical_qubit, !ensemble.physical_qubit) -> ()
              ensemble.apply_distribution %16[%extracted_3] {"cannot-merge"} %extracted_4 : (!ensemble.gate_distribution, i32, !ensemble.physical_qubit) -> ()
              ensemble.apply_distribution %17[%extracted_3] {"cannot-merge"} %extracted_5 : (!ensemble.gate_distribution, i32, !ensemble.physical_qubit) -> ()
            }
            ...
            scf.for %arg3 = %25 to %c25 step %c1 {
              ...
              ensemble.apply_distribution %18[%extracted_4] {"cannot-merge"} %extracted_5 : (!ensemble.gate_distribution, i32, !ensemble.physical_qubit) -> ()
              %26 = ensemble.gate_distribution %10, %9 : (!ensemble.gate, !ensemble.gate) -> !ensemble.gate_distribution
              ensemble.apply_distribution %26[%extracted_3] {"cannot-merge"} %extracted_5 : (!ensemble.gate_distribution, i32, !ensemble.physical_qubit) -> ()
              %27 = arith.muli %extracted_3, %c4_i32 : i32
              %28 = arith.addi %27, %extracted_4 : i32
              ensemble.apply_distribution %19[%28] {"cannot-merge"} %extracted_5 : (!ensemble.gate_distribution, i32, !ensemble.physical_qubit) -> ()
            }
          }
