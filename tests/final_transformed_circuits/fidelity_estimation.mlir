module {
  func.func @main() {
    ...
    affine.for %arg0 = 0 to 1000 {
      %2 = ensemble.int_uniform %c0_i32, %c3_i32, [%c8_i32] : (i32, i32, i32) -> tensor<8xi32>
      ...
      ensemble.quantum_program_iteration {
        ...
        %extracted = tensor.extract %0[%c0] : tensor<8x!ensemble.physical_qubit>
        ensemble.apply %3 {"cannot-merge"} %extracted : (!ensemble.gate, !ensemble.physical_qubit) -> ()
        affine.for %arg1 = 0 to 7 {
          %extracted_2 = tensor.extract %0[%arg1] : tensor<8x!ensemble.physical_qubit>
          %10 = arith.addi %arg1, %c1 : index
          %extracted_3 = tensor.extract %0[%10] : tensor<8x!ensemble.physical_qubit>
          ensemble.apply %4 %extracted_2, %extracted_3 : (!ensemble.gate, !ensemble.physical_qubit, !ensemble.physical_qubit) -> ()
        }
        affine.for %arg1 = 0 to 8 {
          %extracted_2 = tensor.extract %0[%arg1] : tensor<8x!ensemble.physical_qubit>
          %extracted_3 = tensor.extract %2[%arg1] : tensor<8xi32>
          ...
          %extracted_4 = tensor.extract %1[%arg1] : tensor<8x!ensemble.cbit>
