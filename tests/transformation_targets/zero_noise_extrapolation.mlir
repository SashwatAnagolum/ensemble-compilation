module {
    func.func private @iteration_body( %qubits: tensor<21x!ensemble.physical_qubit>, %bits: tensor<21x!ensemble.cbit>) {
        ...
        ensemble.quantum_program_iteration {
            ...
            ensemble.transmit_results %bits : (tensor<21x!ensemble.cbit>) -> ()
        }
        return
    }
    ...
    func.func @main() {
        ...
        %one_index = arith.constant 1 : index
        func.call @iteration_body(%qubits, %bits) : (tensor<21x!ensemble.physical_qubit>, tensor<21x!ensemble.cbit>) -> ()
