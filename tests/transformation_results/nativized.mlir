module {
  func.func @main() {
    ...
    %cst_1 = arith.constant 1.57079637 : f32
    ...
    %2 = ensemble.gate "U3" 1(%cst_1, %cst, %cst_0) {"nativized-created", "nativized-peeked", "zero-noise-peeked"} : (f32, f32, f32) -> !ensemble.gate
    %3 = ensemble.gate "U3" "transpose" 1(%cst_2, %cst_4, %cst_3) {"nativized-created", "nativized-peeked", "zero-noise-created"} : (f32, f32, f32) -> !ensemble.gate
    %4 = ensemble.gate "CX" 2 {"nativized-peeked", "zero-noise-peeked"} : () -> !ensemble.gate
    %5 = ensemble.gate "CX" "transpose" 2 {"nativized-peeked", "zero-noise-created"} : () -> !ensemble.gate
    affine.for %arg0 = 0 to 8 {
      ensemble.quantum_program_iteration {
        ...
        scf.for %arg1 = %c0 to %c20 step %c1 {
          ...
          ensemble.apply %4 {"zero-noise-peeked"} %extracted, %extracted_5 : (!ensemble.gate, !ensemble.physical_qubit, !ensemble.physical_qubit) -> ()
          scf.for %arg2 = %c0 to %arg0 step %c1 {
            ensemble.apply %4 {"zero-noise-created"} %extracted, %extracted_5 : (!ensemble.gate, !ensemble.physical_qubit, !ensemble.physical_qubit) -> ()
            ensemble.apply %5 {"zero-noise-created"} %extracted, %extracted_5 : (!ensemble.gate, !ensemble.physical_qubit, !ensemble.physical_qubit) -> ()
          }
        }
        scf.for %arg1 = %c0 to %c21 step %c1 {
          %extracted = tensor.extract %0[%arg1] : tensor<21x!ensemble.physical_qubit>
