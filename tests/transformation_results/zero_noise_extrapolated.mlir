module {
  func.func @main() {
    ...
    %2 = ensemble.gate "H" 1 {"zero-noise-touched"} : () -> !ensemble.gate
    %3 = ensemble.gate "H" "transpose" 1 {"zero-noise-created"} : () -> !ensemble.gate
    %4 = ensemble.gate "CX" 2 {"zero-noise-touched"} : () -> !ensemble.gate
    ...
    affine.for %arg0 = 0 to 8 {
      ensemble.quantum_program_iteration {
        ...
        scf.for %arg1 = %c0 to %c21 step %c1 {
          ...
          ensemble.apply %2 {"zero-noise-touched"} %extracted : (!ensemble.gate, !ensemble.physical_qubit) -> ()
        ...
        scf.for %arg1 = %c0 to %c20 step %c1 {
          ...
          ensemble.apply %4 {"zero-noise-touched"} %extracted, %extracted_0 : (!ensemble.gate, !ensemble.physical_qubit, !ensemble.physical_qubit) -> ()
          scf.for %arg2 = %c0 to %arg0 step %c1 {
